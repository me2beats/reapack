-- @description Set same icon to children
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
_, tr_icon = r.GetSetMediaTrackInfo_String(tr, 'P_ICON', '', 0)

r.Undo_BeginBlock(); r.PreventUIRefresh(1)

for i = tr_num,last_num do
  local tr = r.GetTrack(0,i)
  r.GetSetMediaTrackInfo_String(tr, 'P_ICON', tr_icon, 1)
end

r.PreventUIRefresh(-1); r.Undo_EndBlock('Set same icon to children', -1)

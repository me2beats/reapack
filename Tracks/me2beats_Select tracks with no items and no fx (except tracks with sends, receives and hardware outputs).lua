-- @description Select tracks with no items and no fx (except tracks with sends, receives and hardware outputs)
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
if tracks ~= 0 then
  ...
  reaper.PreventUIRefresh(-111); reaper.Undo_EndBlock('select tracks with no items and no fx (except tracks with sends, receives and hardware outputs)', 1)

-- @description Restore saved project tab, slot 2
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
local ext_sec, ext_key = 'me2beats_save-restore', 'active_proj_tab_2'
local saved_p_str = r.GetExtState(ext_sec, ext_key)

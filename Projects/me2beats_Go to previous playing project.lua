-- @description Go to previous playing project
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
local iter = enum_playing_projects(0,cur_p_iter-1) or enum_playing_projects(cur_p_iter+1,1000)
...
r.PreventUIRefresh(-1) r.Undo_EndBlock('Go to previous playing project', 2)

-- @description Copy selected regions to cursor (with contents, move later items)
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
function copy_all_items_in_area_to_cursor_moving_later(x,y)
  ...
  function paste_items_moving_later()
    ...
    RestoreSelItems() RestoreSelTracks() r.SetEditCurPos2(0, cur, 0, 0)
...
r.PreventUIRefresh(-1) r.Undo_EndBlock('Copy regions to cursor', -1)

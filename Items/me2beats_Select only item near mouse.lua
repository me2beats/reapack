-- @description Select only item near mouse
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
if r.IsMediaItemSelected(item_c) then bla() return end

r.Undo_BeginBlock() r.PreventUIRefresh(1)
r.Main_OnCommand(40289,0) -- Item: Unselect all items

r.SetMediaItemSelected(item_c,1)
r.UpdateItemInProject(item_c)

r.PreventUIRefresh(-1) r.Undo_EndBlock('Select only item near mouse', -1)

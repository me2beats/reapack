-- @description Move items to time selection end
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
local _,y = r.GetSet_LoopTimeRange(0, 0, 0, 0, 0)

r.Undo_BeginBlock() r.PreventUIRefresh(1)

move_items(y)

r.PreventUIRefresh(-1) r.Undo_EndBlock('Move items to time selection end', -1)

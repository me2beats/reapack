-- @description Select only items from cursor to end of project
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
for i = 0, items-1 do
  ...
  if it_end > cur+0.000001 then t[#t+1] = item end
end
...
r.PreventUIRefresh(-1) r.Undo_EndBlock('Select only items from cursor to end of project', -1)

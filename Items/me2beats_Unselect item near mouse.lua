-- @description Unselect item near mouse
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
if not r.IsMediaItemSelected(item_c) then bla() return end

r.Undo_BeginBlock() r.PreventUIRefresh(1)

r.SetMediaItemSelected(item_c,0)
r.UpdateItemInProject(item_c)

r.PreventUIRefresh(-1) r.Undo_EndBlock('Unselect item near mouse', -1)

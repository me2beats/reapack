-- @description Move selected items to previous track
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
tr = r.GetTrack(0,r.GetMediaTrackInfo_Value(it_tr0, 'IP_TRACKNUMBER')-2)
...
r.Undo_EndBlock('Move selected items to previous track', -1)

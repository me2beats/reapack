-- @description Toggle select item near mouse
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
r.SetMediaItemSelected(item_c,not r.IsMediaItemSelected(item_c))
r.UpdateItemInProject(item_c)

r.PreventUIRefresh(-1) r.Undo_EndBlock('Toggle select item near mouse', -1)

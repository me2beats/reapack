-- @description Trim sel items left edges to nearest grid divisions
-- @version 1.0
-- @author me2beats
-- @changelog
--  + init
...
function hello()
  ...
  start_grid = reaper.BR_GetClosestGridDivision(start_pos)
  reaper.ApplyNudge(0, 1, 1, 1, start_grid, false, 0)
end

items = reaper.CountSelectedMediaItems(0)
if items > 0 then
  script_title = 'Trim sel items left edges to nearest grid divisions'
